...
$compra = mysql_query("SELECT *,date_format(data_venci, '%d/%m/%Y') AS datad, date_format(data, '%d/%m/%Y') AS data FROM faturas WHERE pedido='$pedido' AND situacao !='B'")or die (mysql_error());
$a = 1;
...
// NÃO ALTERAR!
include("include/funcoes_itau_m.php"); 
include("include/carne_itau.php");
