...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="master">
  <tr>
  <!-- ESQUERDA -->
    <td width="180" valign="top" style="border:0;">
    <table width="172" border="0" cellspacing="0" cellpadding="0" style="border:0;">
      <tr>
        <td width="191" valign="top" style="border:0;">
            	<table width="172" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="81" height="37" class="bordaRight"><img src="imagens/logobradesco.jpg" width="75" height="20"></td>
...
Outros acréscimos</span></td>
    ...
    <!-- DIVIDA -->
    <td width="41" valign="top" style="border:0;">&nbsp;</td>
    
    
    <!-- DIREITA -->
    <td width="616" valign="top" style="border:0;">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="90" class="bordaRight"><img src="imagens/logobradesco.jpg" width="75" height="20"></td>
