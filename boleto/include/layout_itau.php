...
<?php /*Caso a impressão seja em lote, não exibir o botão de imprimir */ if (isset($_POST['ids'])){ } else { ?>	



<TR><TD valign=top class=cp style="height: 180px;"><DIV ALIGN="left">

    <?php echo $dadosboleto['texto_boleto']; ?>
    
    <?php echo $dadosboleto['dir_culto']; ?>

    <?php utf8_decode($dadosboleto); } ?>
    ...
    */ ?>
    ...
    <br>
    <span class="campo" style="margin-left: 105px; font-size: 10px;">
        DESTINATÁRIO:
    </span>
    <div class="campo" style="margin-left: 105px; font-size: 14px; ">
        <?php echo $dadosboleto["dest"]?><br>
    </div>
    <span class="campo" style="margin-left: 105px;">
...
cedente</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=12> 
  ...
  <?php echo $dadosboleto["cedente"]?> - CNPJ: <?php echo $dadosboleto["cpf_cnpj"]?>
...
Valor cobrado</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr></tbody> 
 ...
 <div class="campo" style="font-size:14px; margin-left: 20px;">
  <?php echo $dadosboleto["sacado"]?>
</div> 
</td>
</tr></tbody></table>
<table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=659 height=12>

<span class="campo" style="margin-left: 20px;">
  <?php echo $dadosboleto["endereco1"]?> 
</span> 
</td>
</tr></tbody></table>
<table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=472 height=13> 
