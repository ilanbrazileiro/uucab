<style type=text/css>
.cp {  font: 10px Arial; color: black; border-spacing: 0; margin:0;}
.ti {  font: 9px Arial, Helvetica, sans-serif; }
.ld { font: 15px Arial; color: #000000}
.ct { FONT: 9px "Arial Narrow"; COLOR: #000033; }
.cn { FONT: 9px Arial; COLOR: black }
.bc { font: 20px Arial; color: #000000 }
.ld2 { font: 12px Arial; color: #000000 }
.dest{font: 12px; margin: 0 105px 0 0;}

table, td, tr, tbody, th{margin:0;border-spacing:0;padding:0;}

.ct1 { FONT: 9px "Arial Narrow"; COLOR: #000033; width:128px;}
...
<tr><td valign=top class=cp><DIV ALIGN="CENTER">



</DIV></TD></TR>

<TR><TD valign=top class=cp style="height: 180px;"><DIV ALIGN="left">

    <?php echo $dadosboleto['texto_boleto1']; ?>

    <br>

    <span class="ld2">
    &nbsp;&nbsp;&nbsp;&nbsp;Valor: &nbsp;&nbsp;R$ <?php echo $dadosboleto["valor_boleto"]?>&nbsp;&nbsp;/&nbsp;&nbsp;Linha Digitável: &nbsp;<?php echo $dadosboleto["linha_digitavel"]?><br>
    </span>
    <br><br><br>
    
    <table width=105 cellspacing='0' cellpadding='0' border=0>
    <tr><td valign=top class=dest width=105></td><td valign=top style="font-size: 12px;">DESTINATÁRIO: </td></tr>
    <tr><td valign=top class=dest width=105></td><td valign=top style="font-size: 12px;"><?php echo $dadosboleto["dest"]?> </td></tr>
    <tr><td valign=top class=dest width=105></td><td valign=top style="font-size: 12px;"><?php echo $dadosboleto["endereco1"]?> </td></tr>
    <tr><td valign=top class=dest width=105></td><td valign=top style="font-size: 12px;"><?php echo $dadosboleto["endereco2"]?> </td></tr>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=134 height=12> 
  ...
  <span class="campo" style="font-size:14px;">
...
do documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=imagens/1.png width=1 border=0></td><td class=ct1 valign=top height=13>N<u>o</u> 

documento</td><td class=ct valign=top width=6 height=13> <img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=62 height=13>Espécie 
...
<img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=82 height=13>Processamento</td><td class=ct valign=top width=7 height=13> <img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>Nosso 
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left> 
  ...
  </span></div></td><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top height=12> 
  ...
  <td class=cp valign=top width=6 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=62 height=12><div align=left><span class="campo">
...
<img height=1 src=imagens/2.png width=7 border=0></td><td valign=top height=1><img height=1 src=imagens/2.png width=153 border=0></td><td valign=top width=7 height=1> 
...
<tr> <td class=ct valign=top width='10' height='13'><img height='13' src='imagens/1.png' width='1' border='0'></td></tr><tr> 

<td class='cp' valign='top' width='10' height='12'><img height='12' src='imagens/1.png' width='1' border='0'></td></tr><tr> 

<td valign='top' width='10' height='1'><img height='1' src='imagens/2.png' width='1' border='0'></td></tr></tbody></table></td><td class=ct valign='top' width='468' rowspan='5'><font class=ct>Instruções 
...
<?php echo $dadosboleto["instrucoes3"]; ?><br><br>
...
<table cellspacing=0 cellpadding=0 border=0 align=left><tbody><tr><td class=ct valign=top width=10 height=13><img height=13 src=imagens/1.png width=1 border=0></td></tr><tr><td class=cp valign=top width=10 height=12><img height=12 src=imagens/1.png width=1 border=0></td></tr><tr><td valign=top width=10 height=1> 
...
Outras deduções</td></tr><tr><td class=cp valign=top width=7 height=12> <img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr><td valign=top width=5 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=imagens/2.png width=180 border=0></td></tr></tbody></table></td></tr><tr><td align=right width=10> 

<table cellspacing=0 cellpadding=0 border=0 align=left><tbody><tr><td class=ct valign=top width=10 height=13> 

<img height=13 src=imagens/1.png width=1 border=0></td></tr><tr><td class=cp valign=top width=10 height=12><img height=12 src=imagens/1.png width=1 border=0></td></tr><tr><td valign=top width=10 height=1><img height=1 src=imagens/2.png width=1 border=0></td></tr></tbody></table></td><td align=right width=188> 
...
Mora / Multa</td></tr><tr><td class=cp valign=top width=5 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr> 
...
<td class=ct valign=top width=10 height=13><img height=13 src=imagens/1.png width=1 border=0></td></tr><tr><td class=cp valign=top width=10 height=12><img height=12 src=imagens/1.png width=1 border=0></td></tr><tr><td valign=top width=10 height=1><img height=1 src=imagens/2.png width=1 border=0></td></tr></tbody></table></td><td align=right width=188> 

<table cellspacing=0 cellpadding=0 border=0><tbody><tr> <td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>(+) 

Outros acréscimos</td></tr><tr> <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr><td valign=top width=7 height=1><img height=1 src=imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=imagens/2.png width=180 border=0></td></tr></tbody></table></td></tr><tr><td align=right width=10><table cellspacing=0 cellpadding=0 border=0 align=left><tbody><tr><td class=ct valign=top width=10 height=13><img height=13 src=imagens/1.png width=1 border=0></td></tr><tr><td class=cp valign=top width=10 height=12><img height=12 src=imagens/1.png width=1 border=0></td></tr></tbody></table></td><td align=right width=188><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>(=) 
