...
<div id="forms">
  <form action="" method="post" name="formu" id="formu" enctype="multipart/formu-data" onSubmit="return validar(this);">
   <table width="835" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="331"><strong>Diretor(a) Espiritual:</strong> <br><?php echo $cont['dir_culto'] ?></td>
    <td width="233"><strong>CPF:</strong> <br><?php echo $cont['cpfcnpj']; ?></td>
    <td width="271"><strong>RG:</strong> <br><?php echo $cont['rg']; ?></td>
    </tr>
  <tr>
    <td colspan="3"><hr></td>
  </tr>
  ...
  <tr>
        <td width="331"><strong>Nome do Centro:</strong><br> <?php echo $cont['centro'] ?></td>
    <td colspan="3"><br><strong>Endereço do Centro:</strong> <br><?php echo $cont['end_dir']; ?>  Nº <?php echo $cont['numero_dir']; ?> <?php echo $cont['complemento_dir']; ?><br> <?php echo $cont['bairro_dir']; ?>
    - <?php echo $cont['cidade_dir']; ?> - <?php echo $cont['uf_dir']; ?> - CEP: <?php echo $cont['cep_dir'] ?>
    
    </td>
    </tr>
    <tr>
         <td colspan="3"><strong>Endereço Correspôndencia:</strong> <br><?php echo $cont['endereco']; ?>  Nº <?php echo $cont['numero']; ?> <?php echo $cont['complemento']; ?><br> <?php echo $cont['bairro']; ?>
