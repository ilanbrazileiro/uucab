...
<div id="cabecalho"><h2><i class="icon-share "></i> Mesangem de aniversário</h2></div>
<span class="avisos"><strong>Obs: </strong>Está é uma mensagem para os aniversariantes.</span><br/><br/>
<form action="" method="post" enctype="multipart/form-data">
<strong>Assunto do email:</strong><br/>
