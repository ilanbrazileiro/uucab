...
$sqlconf = $conecta->seleciona("SELECT * FROM config")or die (mysql_error());
$linha = mysql_fetch_array($sqlconf);
?>
<div id="entrada">
  ...
  <tr>
    ...
    <table width="79%" border="0" cellspacing="0">
      <tr>
        ...
        <td width="46%" rowspan="10" align="left" valign="top"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="right" valign="middle">Numero</td>
        <td>&nbsp;</td>
        <td align="left" valign="middle"><div class="input-prepend"> <span class="add-on"><i class="icon-file-text"></i></span>
        <input name="numero" type="text" value="<?php echo $linha['numero'] ?>"></div></td>
      </tr>
      <tr>
        <td align="right" valign="middle">Bairro</td>
        <td>&nbsp;</td>
        <td align="left" valign="middle">
       <div class="input-prepend"> <span class="add-on"><i class="icon-file-text"></i></span>
        <input name="bairro" type="text" value="<?php echo $linha['bairro'] ?>"></div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left" valign="middle">
         <div class="input-prepend"> <span class="add-on"><i class="icon-file-text"></i></span>
        <input name="cep" type="text" value="<?php echo $linha['cep'] ?>"></div>
