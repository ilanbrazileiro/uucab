...
if(isset($_POST['editar'])){
		...
		$sql = mysql_query("UPDATE faturas SET ref='$ref', valor='$valor', data_venci='$vencimento', remessa = '0' WHERE id_venda='$id_venda'");
		if($sql == 1){
...
<div id="forms">
  ...
  <br/>
    ...
    <input name="ref" type="text" value="<?php echo $linha['ref'];?>" style="width:400px;" readonly="true"><br/>
