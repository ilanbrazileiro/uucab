...
<div id="entrada">
<div id="cabecalho">
  <h2><i class="icon-print  iconmd"></i> Impressão</h2>
</div>
...
<div id="forms" style="display:table;padding-bottom:5px;">
  <div style="float:left;width:300px"">
    <form action="inicio.php?pg=impressao_lote<?php echo $pags.$part; ?>" method="post" enctype="multipart/form-data">
  ...
  <div style="float:left;width:300px"> <span class="avisos">* Ou entre datas de vencimento</span><br/>
    <form action="inicio.php?pg=impressao_lote<?php echo $pags.$part; ?>" method="post" enctype="multipart/form-data" name="formu" id="formu" onSubmit="return datas(this);">
  ...
  <div style="float:left;width:300px">
   ...
   <div style="float:left;width:300px"> <span class="avisos">* Ou no intervalo de numeros de documentos</span><br/>
    <form action="inicio.php?pg=impressao_lote<?php echo $pags.$part; ?>" method="post" enctype="multipart/form-data">
   ...
   <div style="float:left;width:600px"> <span class="avisos">* Escolha o intervalo da matricula e a referência do mês </span><br/>
    <form action="inicio.php?pg=impressao_lote<?php echo $pags.$part; ?>" method="post" enctype="multipart/form-data">
  ...
  <div style="float:left;width:600px"> <span class="avisos">* Escolha o intervalo da matricula e a referência do ANUAL </span><br/>
    <form action="inicio.php?pg=impressao_lote<?php echo $pags.$part; ?>" method="post" enctype="multipart/form-data">
       <input name="mi" type="text" style="width:100px;" >
      e
      <input name="mf" type="text" style="width:100px;" >
...
?>
<form name="form" action="boleto/boleto_itau.php" method="post" enctype="multipart/form-data" target="_blank" >
  <?php
