...
<div id="entrada">
<div id="cabecalho"><h2><i class="icon-user iconmd"></i> Listagem dos Clientes VIVOS ou ISENTOS </h2></div>

<div id="forms" style="display:table;padding-bottom:5px;">
  
  <div style="float:left; width:600px">
     <form action="inicio.php?pg=listaclientesvivos" method="post" enctype="multipart/form-data">
...
if(isset($_POST["input_pesquisa"]) && $_POST["input_pesquisa"] != ""){
		...
		$sql_1 = "SELECT * FROM cliente WHERE (situacao = 'V' OR situacao = 'I') ";
	...
	$sql_1 = "SELECT * FROM cliente WHERE situacao = 'V' OR situacao = 'I' ORDER BY matricula DESC";
}
...
?>
    ...
    <td align="right">
            ...
            class="btn btn-default" onclick="NovaJanela(this.href,'nomeJanela','950','550','yes');return false" title="Editar">
