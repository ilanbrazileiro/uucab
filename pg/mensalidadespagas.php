...
<div id="entrada">
<div id="cabecalho"><h2><i class="icon-user iconmd"></i> Mensalidades Pagas</h2></div>
...
$sql_1 = "SELECT * FROM cliente WHERE nome LIKE '%$pesquisar%'";
	...
	$sql_1 = "SELECT * FROM mensalidades WHERE ano ='$ano' AND (jan = '1' OR fev = '1' OR mar = '1' OR abr = '1' OR mai = '1' OR jun = '1' OR jul = '1' OR ago = '1' OR setembro = '1' OR outubro = '1' OR nov = '1' OR dez = '1') ORDER BY matricula_cliente DESC";	
}
...
if ($pags>1){
echo "<a class=\"pag\" href=\"#\" onclick=\"sendPost('inicio.php?pg=mensalidadespagas".$part."',{".$filtro."}, '1')\" target=\"_self\">&laquo;&laquo; Primeira</a> ";
}
?>
&nbsp;

<select name="p" onchange="sendPost('inicio.php?pg=mensalidadespagas<?php echo $part;?>',{<?php echo $filtro; ?>}, this.value );" style="width: 50px;">          
...
echo "<a class=\"pag\" href=\"#\" onclick=\"sendPost('inicio.php?pg=mensalidadespagas".$part."',{".$filtro."}, '".$pags."')\" target=\"_self\">Ultima &raquo;&raquo;</a> ";
}
?>
