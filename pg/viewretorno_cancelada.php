...
$sql_1 = "SELECT * FROM relatorio_retorno WHERE c_ocorrencia = '09' AND nosso_numero LIKE '%$pesquisar%' ORDER BY id DESC";

}else{
$sql_1 = "SELECT * FROM relatorio_retorno WHERE c_ocorrencia = '09' ORDER BY id DESC";	
}
