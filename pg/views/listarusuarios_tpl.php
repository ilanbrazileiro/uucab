...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Listar Usuários
      <small>Para adicionar um novo usuário clique no botão verde</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="inicio.php?pg=cadastrarusuarios" class="pull-right btn btn-success"><i class="fa fa-plus"></i> Cadastrar novo</a>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <?php foreach ($usuario->listarTodos() as $key => $e) { ?>
                    <tr>
                      <td><?php echo $key+1 ?></td>
                      <td><?php echo $e['nome'] ?></td>
                      <td><?php echo $e['email'] ?></td>
                      <td><?php echo $e['login'] ?></td>
                      <td><?php echo $e['funcao'] ?></td>                      
