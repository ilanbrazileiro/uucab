...
isset($dadosboleto["data_vencimento"]) ? $fator_vencimento = fator_vencimento($dadosboleto["data_vencimento"]) : $fator_vencimento = '';

//valor tem 10 digitos, sem virgula
isset($dadosboleto["valor_boleto"]) ? $valor = formata_numero($dadosboleto["valor_boleto"],10,0,"valor") : $valor = '';
//agencia é 4 digitos
isset($dadosboleto["agencia"]) ? $agencia = formata_numero($dadosboleto["agencia"],4,0) : $agencia = '';
//conta é 5 digitos + 1 do dv
isset($dadosboleto["conta"]) ? $conta = formata_numero($dadosboleto["conta"],5,0) : $conta = '';
isset($dadosboleto["conta_dv"]) ? $conta_dv = formata_numero($dadosboleto["conta_dv"],1,0) : $conta_dv = '';
//carteira 175
isset($dadosboleto["carteira"]) ? $carteira = $dadosboleto["carteira"] : $carteira = '';
//nosso_numero no maximo 8 digitos
isset($dadosboleto["nosso_numero"]) ? $nnum = formata_numero($dadosboleto["nosso_numero"],8,0) : $nnum = '';
