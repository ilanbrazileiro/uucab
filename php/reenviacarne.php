...
<title>.: Griff sistemas :.</title></head><body>
<?php
...
$sqlss = mysql_query("SELECT *,date_format(data_venci, '%d/%m/%Y') AS data FROM faturas WHERE pedido = '$pedido'") or die(mysql_error());
...
$link = $endereco.'boleto/boletoserie.php?pedido='.$pedido;
$dado = $html;
...
if ( $mail->Send() ){
	 print"<META HTTP-EQUIV=REFRESH CONTENT='0; URL=../inicio.php?pg=recarne&p=".$p."'>
