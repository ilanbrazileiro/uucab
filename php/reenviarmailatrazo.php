...
<title>.: UUCAB - Sistema de Boletos :.</title></head><body>
<?php
require ("../classes/conexao.php");

if(isset($_GET['p'])){
	$p = "pg=fatvencida&p=".$_GET['p'];
	$redireciona = "<META HTTP-EQUIV=REFRESH CONTENT='0; URL=../inicio.php?pg=fatvencida&p=".$p."'>";
}else{
	$p = "pg=fatvencida";
	$redireciona = "<META HTTP-EQUIV=REFRESH CONTENT='0; URL=../inicio.php?pg=fatvencida&p=1'>";
}
